					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#createmultiple-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"createmultiple-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=createmultiple",
									"url": sap.ui.require.toUrl("createmultiple")
								}
							}
						}
					}
